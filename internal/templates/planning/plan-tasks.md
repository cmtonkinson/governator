...
Requirements:
- Tasks must live under `.governator/tasks/` (or the configured task queue directory) and use the markdown structure defined in this repo's task template (`internal/templates/planning/task.md`, which mirrors `v1-reference/.governator/templates/task.md`).
